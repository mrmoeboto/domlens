...
import {createForeignObjectSVG} from '../engines/svg/serializer';
import {loadSerializedSVG} from '../engines/svg/rasterize';
...
// createForeignObjectSVG/loadSerializedSVG moved to engines/svg/{serializer,rasterize}.ts
// (the svg engine owns them now); the foreignObject feature detect above keeps using them.
